...
public class ClienteServiceImpl implements IClienteService{
	...
	public Page<Cliente> findAllPage(Pageable pageable) {	//Con este metodo definimos la cantidad de elementos por pagina
 ...
 *
 * 		Las transacciones son importantes para mantener la integridad y la coherencia de los datos.
 * 		Si varias operaciones deben realizarse como una unidad indivisible (Ej: Recuperar y actualizar datos en la BD
 * 		es esencial que estén dentro de una transacción.
 * 		Si una operación falla, la transacción se revertirá y los cambios se desharán.
 *
 * 		Esta anotación es utilizada para asegurarse de que las operaciones de base de datos sean atómicas y consistentes.
 ...
 * de la cual extraemos los metodos de acceso a BD ya hechos para ahorrarnos trabajo.
 *
 * Por otro lado IClienteService no le rinde cuentas a nadie y simplemente funciona como plantilla donde agregamos
 * los metodos que requiramos para la API. Esta al ser una plantilla, es la que es implemetada por la clase ClienteServiceImpl
 ...
 * IClienteDao implementa CRUDRepository (Los metodos ya hechos por defecto)
 * IClienteServiceImpl usa CRUDRepository(Los metodos ya hechos por defecto) para hacer funcionar los metodos dictados por su plantilla IClienteService
 *
